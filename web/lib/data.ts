// Mock data — typed port of project/data.js (bug-for-bug, exact strings).
// Source: visuals/claude-design-exports/salesforce-consulting-sdlc-app/project/data.js
...
export const DATA: AppData = {
  ...
  reproposal: {
    ...
    changes: [
      ...
      },
      {
        ...
        evidence:
          'Workshop 2026-04-10 @ 14:22: "We need configurable bundles with volume pricing and branded PDFs."',
      },
      {
        type: "reparented",
        label: "Re-parented",
  ...
  currentFocus:
    "Build is on track for Sprint 3 — 60% burned with 4 days left. The CPQ re-proposal is the most consequential open item; Sarah hasn't yet reviewed the diff. Priya can unblock WI-LM-LC-01 this week by answering Q-LM-LC-003.",
