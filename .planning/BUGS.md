...
| BUG-008 | TRANSCRIPT_SESSION conversations render wrong UI at /chat/ | 2 | Fixed | [Detail](bugs/BUG-008.md) |
...
| BUG-035 | Chat tab shows stale pre-feature conversation, new chats missing from sidebar | 2 | Open | [Detail](bugs/BUG-035.md) |
| BUG-037 | Chat window has no scroll — expands entire page height | 2 | Open | [Detail](bugs/BUG-037.md) |
| BUG-038 | New Session type buttons (Story Generation, etc.) do nothing on click | 2 | Open | [Detail](bugs/BUG-038.md) |
| BUG-040 | Generate Stories button throws Prisma conversation.create error | 3 | Open | [Detail](bugs/BUG-040.md) |
| BUG-044 | Bulk status change operations do nothing | 3 | Open | [Detail](bugs/BUG-044.md) |
| BUG-045 | Analysis tab Prisma error — isArchived unknown on conversation.findMany() | 2 | Open | [Detail](bugs/BUG-045.md) |
| BUG-047 | Assigned To dropdown shows no members or displays raw user IDs | 2 | Open | [Detail](bugs/BUG-047.md) |
| BUG-010 | Sprint board drag-and-drop has no role awareness | 3 | Fixed | [Detail](bugs/BUG-010.md) |
...
| ID | Title | Phase | Status | Detail |
|----|-------|-------|--------|--------|
| BUG-015 | Role-based nav has no restrictions on Phase 2 features | 1 | Fixed | [Detail](bugs/BUG-015.md) |
| BUG-016 | Transcript messages API doesn't validate ownership | 2 | Fixed | [Detail](bugs/BUG-016.md) |
| BUG-017 | Knowledge article summary never updated during refresh | 2 | Fixed | [Detail](bugs/BUG-017.md) |
...
| BUG-024 | No UI to create test cases — QA tab dead end | 5 | Fixed | [Detail](bugs/BUG-024.md) |
| BUG-025 | Revisited STORY_SESSION conversations broken — epicId URL-only | 7 | Fixed | [Detail](bugs/BUG-025.md) |
| BUG-034 | Projects tab shows no content — only displays project name | 1 | Open | [Detail](bugs/BUG-034.md) |
| BUG-036 | Archive button on conversations may not work | 2 | Open | [Detail](bugs/BUG-036.md) |
| BUG-039 | Work tab UI is clunky and unclear — hard to tell epics from features | 3 | Open | [Detail](bugs/BUG-039.md) |
| BUG-041 | Kanban board drag-and-drop doesn't work for features/epics | 3 | Open | [Detail](bugs/BUG-041.md) |
| BUG-043 | Feature details are not editable — no edit UI | 3 | Open | [Detail](bugs/BUG-043.md) |
| BUG-046 | Picklist dropdowns show raw API values instead of human-readable labels | 1 | Open | [Detail](bugs/BUG-046.md) |
...
| BUG-027 | bulkConfirmHighConfidence confirms ALL records | 4 | Fixed | [Detail](bugs/BUG-027.md) |
...
| BUG-030 | Document detail nests anchor inside button | 5 | Fixed | [Detail](bugs/BUG-030.md) |
| BUG-031 | Sidebar fallback paths 404 when no project active | CC | Fixed | [Detail](bugs/BUG-031.md) |
| BUG-042 | Feature and Story detail pages are too basic — missing fields | 3 | Open | [Detail](bugs/BUG-042.md) |
